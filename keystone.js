...
keystone.set('nav', {
	payments: ['PretPayment', 'PretTestCode'],
	candidates: ['PretCandidate', 'PretNotification', 'PretNotificationReadReceipt'],
	//CandidateDocuments: ['CandidateDocument', 'SkillAnalysisResult', 'SeekerResult', 'StartupResult'],
	// Institutions: ['Institution', 'Industry'],
	Marketing: ['PretAffiliate', 'PretCoupon'],
	// Admin: 'Admin',
	//poll: ['Poll', 'PollVote'],
	newsletter: 'PretNewsletter',
	country: ['State', 'LocalGovernment'],
	//posts: ['posts', 'post-categories'],
	//galleries: 'galleries',
	enquiries: 'PretGuestEnquiry',
	users: ['keystonePretAdmin', 'users'],
});
